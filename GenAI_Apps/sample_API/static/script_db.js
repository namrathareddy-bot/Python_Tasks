...
// Toggles the opening/closing of the SQL details accordion
...
// Appends a rich AI response with an interactive SQL details accordion
function appendResponse(data) {
    ...
    // Sub-component: Execution Results
